...
for i in range(N_t):
    ...
    if i == 200:
        ...
        progress_20 = s_m
        metrics_save(S_obs_record,initial_params,progress_20,progress_40,TTC_record,vel,acc,steer_record,lane_state_record,path_record,C_label_record,initial_vds,"200",comparison="Comparison_NoIDEAS")
