...
def one_round(dir_given):
    ...
    for i in range(N_t):
        ...
        C_label_additive = utils.inquire_C_state_for_noadapt(C_label,desired_group)
        ...
        if i == 200:
            ...
            progress_20 = s_m
            metrics_save(S_obs_record,initial_params,progress_20,progress_40,TTC_record,vel,acc,steer_record,lane_state_record,path_record,C_label_record,initial_vds,"200",round_=round_,comparison="Comparison_NoIDEAS")
        ...
        if i == 400:
            ...
            s_m,ey_m,epsi_m = find_frenet_coord(path_m, x_m, y_m, samples_m,X0_g)
            progress_40 = s_m 
            metrics_save(S_obs_record,initial_params,progress_20,progress_40,TTC_record,vel,acc,steer_record,lane_state_record,path_record,C_label_record,initial_vds,"400",round_=round_,comparison="Comparison_NoIDEAS")
            break
        ...
        oa, od, ovx, ovy, owz, oS, oey, oepsi = mpc_controller.iterative_linear_mpc_control_for_noadapt(X0, oa, od, dt, GPR_vy, GPR_w, C_label,  X0_g, path_d, last_X, path_now, ego_group, path_ego, desired_group,vehicle_left,vehicle_centre,vehicle_right,path_dindex,C_label_additive,C_label_virtual)
