...
def constraint_params():     
    ...
    Q = [np.diag([2.0,6.0,10.0,0.0,60.0,70.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,60.0,70.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,60.0,70.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,60.0,80.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,60.0,80.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,70.0,80.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,70.0,80.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,70.0,80.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,70.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,70.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,80.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,80.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,90.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,90.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,90.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,100.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,100.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,100.0,90.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,110.0,100.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,110.0,100.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,120.0,110.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,120.0,110.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,120.0,120.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,120.0,120.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,120.0,120.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,120.0,120.0])*0.1,
          np.diag([2.0,6.0,10.0,0.0,120.0,120.0])*0.1,
    ...
    Rssl = np.diag([800,0])*0.1
    Rssr = np.diag([800,0])*0.1
    Rhocbf1 = np.diag([1000,0])*0.1
    Rhocbf2 = np.diag([1000,0])*0.1
