...
def constraint_params():     
    ...
    Q = [np.diag([3.5,40.0,40.0,0.0,60.0,70.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,60.0,70.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,60.0,70.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,60.0,80.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,60.0,80.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,70.0,80.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,70.0,80.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,70.0,80.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,70.0,90.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,70.0,90.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,80.0,90.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,80.0,90.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,90.0,90.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,90.0,90.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,90.0,90.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,90.0,100.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,90.0,100.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,90.0,100.0])*0.1,
          np.diag([3.5,40.0,40.0,0.0,90.0,110.0])*0.1,
    ...
    Pw1 = np.diag([5,0.0])*0.1
    Pw2 = np.diag([5,0.0])*0.1
