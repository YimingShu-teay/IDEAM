...
def constraint_params():     
    ...
    Q = [np.diag([4.0,40.0,40.0,0.0,60.0,70.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,60.0,70.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,60.0,70.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,60.0,80.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,60.0,80.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,70.0,80.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,70.0,80.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,70.0,80.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,70.0,90.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,70.0,90.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,80.0,90.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,80.0,90.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,90.0,90.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,90.0,90.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,90.0,90.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,90.0,100.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,90.0,100.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,90.0,100.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,90.0,110.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,120.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,120.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,120.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,120.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,120.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,140.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,160.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,180.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,200.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,240.0])*0.1,
          np.diag([4.0,40.0,40.0,0.0,100.0,240.0])*0.1]
    Qt = np.diag([0.0,600.0])*0.1
    P = np.diag([5.0,0.0])*0.1
    Pw1 = np.diag([10,0.0])*0.1
    Pw2 = np.diag([10,0.0])*0.1
    ...
    Rhocbf1 = np.diag([900,0])*0.1
    Rhocbf2 = np.diag([900,0])*0.1
