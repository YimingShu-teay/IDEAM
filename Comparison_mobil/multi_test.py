...
def one_round(dir_given):
    ...
    decision_params = mobil_params()
    mobil = MOBIL(**decision_params)
    ...
    for i in range(N_t-2):
        ...
        desired_group = mobil.make_decision(group_dict,ego_group,X0,X0_g,path_now)
        ...
        if i == 200:
            ...
            progress_20 = s_m
            metrics_save(S_obs_record,initial_params,progress_20,progress_40,TTC_record,vel,acc,steer_record,lane_state_record,path_record,C_label_record,initial_vds,"200",round_=round_,comparison="Comparison_mobil")
        ...
        if i == 400:
            ...
            s_m,ey_m,epsi_m = find_frenet_coord(path_m, x_m, y_m, samples_m,X0_g)
            progress_40 = s_m 
            metrics_save(S_obs_record,initial_params,progress_20,progress_40,TTC_record,vel,acc,steer_record,lane_state_record,path_record,C_label_record,initial_vds,"400",round_=round_,comparison="Comparison_mobil")
            break
        
        ################################# MPC solve and total env propogate ############           
        print("Last_X=",last_X[3])
        print("Last_X=",last_X[4])
    ...
    ################################## plot information about ego vehicles and surrounding vehicles ########################################################
        ...
        # print(dirpath+"\\figsave\\{}.png".format(i))
